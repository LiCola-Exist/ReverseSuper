...
[ ![Download](https://api.bintray.com/packages/licola/maven/ReverseSuper-annotation/images/download.svg) ](https://bintray.com/licola/maven/ReverseSuper-annotation/_latestVersion)
[ ![Download](https://api.bintray.com/packages/licola/maven/ReverseSuper-compiler/images/download.svg) ](https://bintray.com/licola/maven/ReverseSuper-compiler/_latestVersion)
...
同样还有```@ReverseExtend```注解对目标类生成抽象类。使用类似参见[Adapter](https://github.com/LiCola/ReverseSuper/blob/master/app/src/main/java/com/model/licola/reversesuper/Adapter.java)
